@section('title')
    <title>Edit Presensi Kelas 3 Sunflower</title>
@endsection
...
<div class="">
    <div class="clearfix"></div>
        <div class="row">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Edit Presensi Siswa Kelas 3 Sunflower</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                    ...
                    <form action="{{url('/presensi/update')}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    @csrf
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" name="id_presensi" required="required" value="{{$p->id_presensi}}" class="form-control " hidden>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" name="nama_siswa" required="required" value="{{$p->nama_siswa}}" class="form-control " readonly>
                            </div>
                        </div>
                        <div class="item form-group">

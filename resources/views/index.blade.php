...
<html lang="en">
  <head>
    ...
    <!-- iCheck -->
    <link href="tmp1/vendors/iCheck/skins/flat/green.css" rel="stylesheet">
	
    <!-- bootstrap-progressbar -->
    <link href="tmp1/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="tmp1/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="tmp1/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
  ...
  <body class="nav-md footer_fixed">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="151811513039.jpg" alt="..." class="img-circle profile_img">
              </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="151811513039.jpg" alt="">Hanifah Nurul Laili
                  </a>
    ...
    <!-- jQuery -->
    <script src="tmp1/vendors/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="tmp1/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <!-- FastClick -->
    <script src="tmp1/vendors/fastclick/lib/fastclick.js"></script>
    <!-- NProgress -->
    <script src="tmp1/vendors/nprogress/nprogress.js"></script>
    <!-- Chart.js -->
    <script src="tmp1/vendors/Chart.js/dist/Chart.min.js"></script>
    <!-- gauge.js -->
    <script src="tmp1/vendors/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    <script src="tmp1/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <!-- iCheck -->
    <script src="tmp1/vendors/iCheck/icheck.min.js"></script>
    <!-- Skycons -->
    <script src="tmp1/vendors/skycons/skycons.js"></script>
    <!-- Flot -->
    <script src="tmp1/vendors/Flot/jquery.flot.js"></script>
    <script src="tmp1/vendors/Flot/jquery.flot.pie.js"></script>
    <script src="tmp1/vendors/Flot/jquery.flot.time.js"></script>
    <script src="tmp1/vendors/Flot/jquery.flot.stack.js"></script>
    <script src="tmp1/vendors/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="tmp1/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="tmp1/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="tmp1/vendors/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="tmp1/vendors/DateJS/build/date.js"></script>
    <!-- JQVMap -->
    <script src="tmp1/vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="tmp1/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="tmp1/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <!-- bootstrap-daterangepicker -->
    <script src="tmp1/vendors/moment/min/moment.min.js"></script>
    <script src="tmp1/vendors/bootstrap-daterangepicker/daterangepicker.js"></script>

    <!-- Custom Theme Scripts -->
    <script src="tmp1/build/js/custom.min.js"></script>

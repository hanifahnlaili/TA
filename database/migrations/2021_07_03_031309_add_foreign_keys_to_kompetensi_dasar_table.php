...
class AddForeignKeysToKompetensiDasarTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('kompetensi_dasar', function (Blueprint $table) {
            ...
            $table->foreign(['ID_TAHUNPELAJARAN', 'ID_MATAPELAJARAN'], 'FK_MEMILIKI_1')->references(['ID_TAHUNPELAJARAN', 'ID_MATAPELAJARAN'])->on('detail_mata_pelajaran')->onUpdate('RESTRICT')->onDelete('RESTRICT');
        });
    }
